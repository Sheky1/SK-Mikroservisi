...
public class SecurityAspect {
    ...
    public SecurityAspect(TokenServis tokenServis) {
        this.tokenServis = tokenServis;
    }

    @Around("@annotation(com.sk.karte.security.CheckSecurity)")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        //Try to parse token
        Claims claims = tokenServis.parseToken(token);
